				...
				<table width="98%" border="0" cellpadding="2" cellspacing="1" align="center" style="margin-top: 8px">
					...
					<tr align="center">
						...
						<td class="td_Right">
									...
									<input style="width: 300px;" type="text"  id="user_report_press" value="${user_report.press}" />
						</td>
					</tr>
					<tr align="center">
						...
						<td class="td_Right">
							...
							<input style="width: 300px;" type="text"  id="user_report_issuingCountry" value="${user_report.issuingCountry}" />
						</td>
					</tr>
						<tr align="center">
						<td class="td_Left">年份：</td>
						<td class="td_Right">
							<input style="width: 300px;" type="text"  id="user_report_date" value="${user_report.year}" />
						</td>
					</tr>
				</table>
			</div>
