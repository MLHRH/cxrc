		...
		<div class="control-group" align="left">
			...
			<table id="people" border="0" cellpadding="2" cellspacing="1" align="center" style="margin-top: 8px; margin-left: 0px;">
				...
				<tr align="left">
					...
					<td>
						<input type="text" id="user_current_zhicheng" style="width: 200px" value="${userbaseinfor.zhicheng}" />
					</td>
				...
				<tr align="left">
					...
					<td>
						<input type="text" id="within_beijing" style="width: 200px" value="${userbaseinfor.within_beijing}" />
					</td>
				</tr>
