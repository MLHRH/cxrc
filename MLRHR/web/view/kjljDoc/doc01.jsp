...
<body>
	...
	<p class=MsoNormal style='text-align: center'>
		<b> <span
			style='font-size: 22.0pt; font-family: 幼圆; letter-spacing: 1.0pt'>基本信息</span>
		</b>
	</p>
	...
	<table class=MsoNormalTable border=1 cellspacing=0 cellpadding=0
		width=631 style='width: 100%; border-collapse: collapse; border: none'>
		<tr style='page-break-inside: avoid; height: 38pt'>

			<td valign="middle"
				style='width: 50pt; border: solid windowtext 1.0pt; padding: 0cm 5.4pt 0cm 5.4pt; height: 40.8pt'>
				<div class=MsoNormal style='text-align: center'>
					<span style='font-size: 16.0pt; font-family: 仿宋'> 姓名 </span>
				</div>
			</td>
			<td colspan=2 valign="middle"
				style='width: 75pt; border: solid windowtext 1.0pt; padding: 0cm 5.4pt 0cm 5.4pt; height: 40.8pt'>
			...
			<td width=94 valign="middle"
				style='width: 70.85pt; border: solid windowtext 1.0pt; border-left: none; padding: 0cm 5.4pt 0cm 5.4pt; height: 40.8pt'>
				<div class=MsoNormal style='text-align: center'>
					<span style='font-size: 16.0pt; font-family: 仿宋'> 性 <span
						lang=EN-US>&nbsp; </span> 别
					</span>
				</div>
			</td>
			<td valign="middle"
				style='width: 50pt; border: solid windowtext 1.0pt; border-left: none; padding: 0cm 5.4pt 0cm 5.4pt; height: 40.8pt'>

				<input type="text" id="sex"
				style="text-align: center; font-size: 16.0pt; font-family: 仿宋; display: inline-block; height: 90%; width: 95%; padding: 0px; margin: 3px; border-radius: 0px" />

			</td>
			<td width=85 colspan=3 valign="middle"
				style='width: 63.8pt; border: solid windowtext 1.0pt; border-left: none; padding: 0cm 5.4pt 0cm 5.4pt; height: 40.8pt'>
				<div class=MsoNormal style='text-align: center'>
					<span style='font-size: 16.0pt; font-family: 仿宋'> 民族 </span>
				</div>
			</td>
			<td width=57 colspan=2 valign="middle"
				style='width: 42.5pt; border: solid windowtext 1.0pt; border-left: none; padding: 0cm 5.4pt 0cm 5.4pt; height: 40.8pt'>
				<input type="text" id="user_minzu"
				style="text-align: center; font-size: 16.0pt; font-family: 仿宋; display: inline-block; height: 90%; width: 95%; padding: 0px; margin: 3px; border-radius: 0px" />
			</td>
			<td width=95 rowspan=2 valign="middle"
				style='width: 70.9pt; border: solid windowtext 1.0pt; border-left: none; padding: 0cm 5.4pt 0cm 5.4pt; height: 40.8pt'>
				<p class=MsoNormal style='text-align: center'>
		...
		<tr style='page-break-inside: avoid; height: 38pt'>
			<td valign="middle"
				style='border-top: none; border-left: solid windowtext 1.0pt; border-bottom: solid windowtext 1.0pt; border-right: solid windowtext 1.0pt; padding: 0cm 5.4pt 0cm 5.4pt; height: 37.7pt'>
				<div class=MsoNormal style='text-align: center'>
		...
		<tr style='page-break-inside: avoid; height: 38pt'>
			<td width=130 colspan=2
				style='width: 97.55pt; border: solid windowtext 1.0pt; border-top: none; padding: 0cm 5.4pt 0cm 5.4pt; height: 39.05pt'>
				<div class=MsoNormal style='text-align: center'>
			...
			<td width=94
				style='width: 70.85pt; border-top: none; border-left: none; border-bottom: solid windowtext 1.0pt; border-right: solid windowtext 1.0pt; padding: 0cm 5.4pt 0cm 5.4pt; height: 37.7pt'>
				<div class=MsoNormal style='text-align: center'>
		...
		<tr style='page-break-inside: avoid; height: 41.75pt'>
			...
			<td width=208 colspan=5 valign="middle"
				...
				<input type="text" id="declaration_area"
				style="text-align: center; font-size: 16.0pt; font-family: 仿宋; display: inline-block; height: 90%; width: 95%; padding: 0px; margin: 3px; border-radius: 0px" />
			</td>
		</tr>
		<tr style='page-break-inside: avoid; height: 38pt'>
		...
		<tr style='page-break-inside: avoid'>
			<td width=36 rowspan=3 valign="middle"
				style='width: 26.7pt; border: solid windowtext 1.0pt; border-top: none; padding: 0cm 5.4pt 0cm 5.4pt'>
				<div class=MsoNormal style='text-align: center'>
		...
		<tr style='page-break-inside: avoid; height: 38pt'>
			...
			<td width=99 colspan=3 valign="middle"
				style='width: 2.0cm; border-top: none; border-left: none; border-bottom: solid windowtext 1.0pt; border-right: solid windowtext 1.0pt; padding: 0cm 5.4pt 0cm 5.4pt; height: 38pt'>
				<input type="text" id="work_starttime"
				onfocus="WdatePicker({isShowWeek:true,dateFmt:'yyyy.MM.dd'})"
				style="text-align: center; font-size: 16.0pt; font-family: 仿宋; display: inline-block; height: 90%; width: 95%; padding: 0px; margin: 3px; border-radius: 0px" />
			</td>
			<td width=99 colspan=2 valign="middle"
				style='width: 99.25pt; border-top: none; border-left: none; border-bottom: solid windowtext 1.0pt; border-right: solid windowtext 1.0pt; padding: 0cm 5.4pt 0cm 5.4pt; height: 38pt'>
				<input type="text" id="work_endtime"
				onfocus="WdatePicker({isShowWeek:true,dateFmt:'yyyy.MM.dd'})"
				style="text-align: center; font-size: 16.0pt; font-family: 仿宋; display: inline-block; height: 90%; width: 95%; padding: 0px; margin: 3px; border-radius: 0px" />
			</td>
		</tr>
		<tr style='page-break-inside: avoid'>
			<td width=36 rowspan=4 valign="middle"
				style='width: 26.7pt; border: solid windowtext 1.0pt; border-top: none; padding: 0cm 5.4pt 0cm 5.4pt'>
				<div class=MsoNormal style='text-align: center'>
		...
		<tr style='page-break-inside: avoid; height: 41.75pt'>
			...
			<td width=208 colspan=5 valign="middle"
				style='width: 155.95pt; border-top: none; border-left: none; border-bottom: solid windowtext 1.0pt; border-right: solid windowtext 1.0pt; padding: 0cm 5.4pt 0cm 5.4pt; height: 41.75pt'>
				<input type="text" id="organization_code"
				style="text-align: center; font-size: 16.0pt; font-family: 仿宋; display: inline-block; height: 90%; width: 95%; padding: 0px; margin: 3px; border-radius: 0px" />
			</td>
		</tr>
		<tr style='page-break-inside: avoid; height: 41.75pt'>
			...
			<td width=208 colspan=5 valign="middle"
				style='width: 155.95pt; border-top: none; border-left: none; border-bottom: solid windowtext 1.0pt; border-right: solid windowtext 1.0pt; padding: 0cm 5.4pt 0cm 5.4pt; height: 41.75pt'>
				<input type="text" id="supervisor_unit"
				style="text-align: center; font-size: 16.0pt; font-family: 仿宋; display: inline-block; height: 90%; width: 95%; padding: 0px; margin: 3px; border-radius: 0px" />
			</td>
		</tr>
		<tr style='page-break-inside: avoid; height: 41.75pt'>
