...
function initjcqnDoc02() {
	$.ajax({
				...
				success : function(data) { // 请求成功后处理函数。
					...
					$('#project_name1').val(data[0].entryName);
					$('#project_page1').val(data[0].projectNumber);
					$('#project_money1').val(data[0].funds);
					$('#start_end_date1').val(data[0].startStopTime);
					$('#project_character1').val(data[0].projectNature);
					$('#project_role1').val(data[0].role);
					
					$('#project_name2').val(data[1].entryName);
					$('#project_page2').val(data[1].projectNumber);
					$('#project_money2').val(data[1].funds);
					$('#start_end_date2').val(data[1].startStopTime);
					$('#project_character2').val(data[1].projectNature);
					$('#project_role2').val(data[1].role);
					
					$('#project_name3').val(data[2].entryName);
					$('#project_page3').val(data[2].projectNumber);
					$('#project_money3').val(data[2].funds);
					$('#start_end_date3').val(data[2].startStopTime);
					$('#project_character3').val(data[2].projectNature);
					$('#project_role3').val(data[2].role);
					
					$('#project_name4').val(data[3].entryName);
					$('#project_page4').val(data[3].projectNumber);
					$('#project_money4').val(data[3].funds);
					$('#start_end_date4').val(data[3].startStopTime);
					$('#project_character4').val(data[3].projectNature);
					$('#project_role4').val(data[3].role);
					
					$('#project_name5').val(data[4].entryName);
					$('#project_page5').val(data[4].projectNumber);
					$('#project_money5').val(data[4].funds);
					$('#start_end_date5').val(data[4].startStopTime);
					$('#project_character5').val(data[4].projectNature);
					$('#project_role5').val(data[4].role);
					
					$('#project_name6').val(data[5].entryName);
					$('#project_page6').val(data[5].projectNumber);
					$('#project_money6').val(data[5].funds);
					$('#start_end_date6').val(data[5].startStopTime);
					$('#project_character6').val(data[5].projectNature);
					$('#project_role6').val(data[5].role);

					
					$('#02xuhao1').val(data[6].id);
					$('#award_item_name1').val(data[6].awardItemName);
					$('#prize_name1').val(data[6].prizeName);
					$('#grade1').val(data[6].grade);
					$('#sort1').val(data[6].sort);
					$('#reward_time1').val(data[6].rewardTime);
					$('#grant_institution1').val(data[6].grantInstitution);
					$('#02xuhao2').val(data[7].id);
					$('#award_item_name2').val(data[7].awardItemName);
					$('#prize_name2').val(data[7].prizeName);
					$('#grade2').val(data[7].grade);
					$('#sort2').val(data[7].sort);
					$('#reward_time2').val(data[7].rewardTime);
					$('#grant_institution2').val(data[7].grantInstitution);
					$('#02xuhao3').val(data[8].id);
					$('#award_item_name3').val(data[8].awardItemName);
					$('#prize_name3').val(data[8].prizeName);
					$('#grade3').val(data[8].grade);
					$('#sort3').val(data[8].sort);
					$('#reward_time3').val(data[8].rewardTime);
					$('#grant_institution3').val(data[8].grantInstitution);
					$('#02xuhao4').val(data[9].id);
					$('#award_item_name4').val(data[9].awardItemName);
					$('#prize_name4').val(data[9].prizeName);
					$('#grade4').val(data[9].grade);
					$('#sort4').val(data[9].sort);
					$('#reward_time4').val(data[9].rewardTime);
					$('#grant_institution4').val(data[9].grantInstitution);
//	TODO				
					
					$('#03xuhao1').val(data[10].id);
