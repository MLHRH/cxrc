...
function updatejcqnDoc01() {
	...
	var jcqn = {};
	jcqn.user_id = userid;
	jcqn.name = $("#userName2").val();
    jcqn.birthday = $("#user_birthday").val();
	jcqn.sex = $("#sex").val();
	jcqn.minzu = $("#user_minzu").val();
    jcqn.title = $("#title").val();
	jcqn.document_type=$("#document_type").val();
	jcqn.document_number= $("#document_number").val();
	jcqn.direction=$("#direction").val();
	jcqn.declaration_area=$("#declaration_area").val();
	jcqn.telephone=$("#telephone").val();
    jcqn.fax= $("#fax").val();
	jcqn.mobile_phone=$("#mobile_phone").val();
	jcqn.email=$("#email").val();
	jcqn.zip_code=$("#zip_code").val();
	jcqn.addresses=$("#addresses").val();
    jcqn.unit_name=$("#unit_name").val();
	jcqn.organization_code=$("#organization_code").val();
	jcqn.legal_representative=$("#legal_representative").val();
	jcqn.supervisor_unit=$("#supervisor_unit").val();
	jcqn.unit_address=$("#unit_address").val();
	jcqn.postcode=$("#postcode").val();
	jcqn.unit_contact=$("#unit_contact").val();
	jcqn.work_telephone= $("#work_telephone").val();
	jcqn.work_fax=$("#work_fax").val();
	  $.ajax({
				dataType : "json",
				type : "POST",
				url : "jcqnDoc01Update",
				data : {
					"jcqn" : JSON.stringify(jcqn),
					"zuzhis" : zuzhiList,
					"studys" : studyList,
					"works" : workList
				},
