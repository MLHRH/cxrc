...
<body lang=ZH-CN style='text-justify-trim: punctuation'>
	<div class="modal hide" id="modalDoc03" style="width: 794px;">
		<div class="modal-header">
			<button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
			<h3 id="modalDoc03Title">附件窗口</h3>
		</div>
		<div id="modalDoc03BodyId" class="modal-body" style="min-height: 300px; max-height: 500px;"></div>
	...
	<div align=center style='text-align: center; height: 56px'>
		<b style='vertical-align: middle; margin: 0 auto;'>
			<span style='font-size: 18.0pt; font-family: 仿宋'>业绩成果材料复印件</span>
		</b>
		<a style='vertical-align: middle; margin-left:5px; float: right;' class="btn  btn-info" href="javascript:void(0)" onClick="downLoadFile_03()">
			<i class="icon-download"></i>下载
		</a>
		<a style='vertical-align: middle; margin: 0 auto; float: right;' class="btn  btn-info" href="javascript:void(0)" onClick="checkFilePDF()">
		...
		<table class=MsoNormalTable border=1 cellspacing=0 cellpadding=0 style='border-collapse: collapse; border: none'>
			...
			<tr style='height: 34.0pt'>
				...
				<td width=383
					...
					<p class=MsoNormal>
						<span style='font-size: 16.0pt; font-family: 仿宋'>著作</span>
					</p>
				</td>
				<td width=67 style='width: 50.5pt; border-top: none; border-left: none; border-bottom: solid windowtext 1.0pt; border-right: solid windowtext 1.0pt; padding: 0cm 5.4pt 0cm 5.4pt; height: 34.0pt'>
					<p class=MsoNormal align=center style='text-align: center'>
						<span id='ftPDF01' lang=EN-US style='font-size: 16.0pt; font-family: 仿宋'>&nbsp;</span>
					</p>
				</td>
				...
				<td width=67 style='width: 50.55pt; border-top: none; border-left: none; border-bottom: solid windowtext 1.0pt; border-right: solid windowtext 1.0pt; padding: 0cm 5.4pt 0cm 5.4pt; height: 34.0pt'>
					<p class=MsoNormal align=center style='text-align: center'>
						<span lang=EN-US style='font-size: 16.0pt; font-family: 仿宋'>
							<a class="btn btn-small btn-info" href="javascript:void(0)" onClick="uploadFilePDF(1)">
			...
			<tr>
				...
				<td width=383 style='width: 287.45pt; border-top: none; border-left: none; border-bottom: solid windowtext 1.0pt; border-right: solid windowtext 1.0pt; padding: 0cm 5.4pt 0cm 5.4pt'>
					<p class=MsoNormal>
						<span style='font-size: 16.0pt; font-family: 仿宋'>论文</span>
					</p>
				</td>
				<td width=67 style='width: 50.5pt; border-top: none; border-left: none; border-bottom: solid windowtext 1.0pt; border-right: solid windowtext 1.0pt; padding: 0cm 5.4pt 0cm 5.4pt'>
					<p class=MsoNormal align=center style='text-align: center; line-height: 150%'>
						<span id='ftPDF02' lang=EN-US style='font-size: 16.0pt; line-height: 150%; font-family: 仿宋'>&nbsp;</span>
					</p>
				</td>
				...
				<td width=67 style='width: 50.55pt; border-top: none; border-left: none; border-bottom: solid windowtext 1.0pt; border-right: solid windowtext 1.0pt; padding: 0cm 5.4pt 0cm 5.4pt; height: 34.0pt'>
					<p class=MsoNormal align=center style='text-align: center'>
						<span lang=EN-US style='font-size: 16.0pt; font-family: 仿宋'>
							<a class="btn btn-small btn-info" href="javascript:void(0)" onClick="uploadFilePDF(2)">
								<i class="icon-upload"></i>管理
							</a>
						</span>
					</p>
			...
			<tr>
				...
				<td width=383 style='width: 287.45pt; border-top: none; border-left: none; border-bottom: solid windowtext 1.0pt; border-right: solid windowtext 1.0pt; padding: 0cm 5.4pt 0cm 5.4pt'>
					<p class=MsoNormal>
						<span style='font-size: 16.0pt; font-family: 仿宋'>报告</span>
					</p>
				</td>
				<td width=67 style='width: 50.5pt; border-top: none; border-left: none; border-bottom: solid windowtext 1.0pt; border-right: solid windowtext 1.0pt; padding: 0cm 5.4pt 0cm 5.4pt'>
					<p class=MsoNormal align=center style='text-align: center; line-height: 150%'>
						<span id='ftPDF03' lang=EN-US style='font-size: 16.0pt; line-height: 150%; font-family: 仿宋'>&nbsp;</span>
					</p>
				</td>
				<td width=67 style='width: 50.55pt; border-top: none; border-left: none; border-bottom: solid windowtext 1.0pt; border-right: solid windowtext 1.0pt; padding: 0cm 5.4pt 0cm 5.4pt'>
					<p class=MsoNormal align=center style='text-align: center; line-height: 150%'>
				...
				<td width=67 style='width: 50.55pt; border-top: none; border-left: none; border-bottom: solid windowtext 1.0pt; border-right: solid windowtext 1.0pt; padding: 0cm 5.4pt 0cm 5.4pt; height: 34.0pt'>
					<p class=MsoNormal align=center style='text-align: center'>
						<span lang=EN-US style='font-size: 16.0pt; font-family: 仿宋'>
							<a class="btn btn-small btn-info" href="javascript:void(0)" onClick="uploadFilePDF(3)">
								<i class="icon-upload"></i>管理
							</a>
						</span>
					</p>
			...
			<tr>
				...
				<td width=383 style='width: 287.45pt; border-top: none; border-left: none; border-bottom: solid windowtext 1.0pt; border-right: solid windowtext 1.0pt; padding: 0cm 5.4pt 0cm 5.4pt'>
					<p class=MsoNormal>
						<span style='font-size: 16.0pt; font-family: 仿宋'>其他</span>
					</p>
				</td>
				<td width=67 style='width: 50.5pt; border-top: none; border-left: none; border-bottom: solid windowtext 1.0pt; border-right: solid windowtext 1.0pt; padding: 0cm 5.4pt 0cm 5.4pt'>
					<p class=MsoNormal align=center style='text-align: center; line-height: 150%'>
						<span id='ftPDF04' lang=EN-US style='font-size: 16.0pt; line-height: 150%; font-family: 仿宋'>&nbsp;</span>
					</p>
				</td>
				<td width=67 style='width: 50.55pt; border-top: none; border-left: none; border-bottom: solid windowtext 1.0pt; border-right: solid windowtext 1.0pt; padding: 0cm 5.4pt 0cm 5.4pt'>
					<p class=MsoNormal align=center style='text-align: center; line-height: 150%'>
				...
				<td width=67 style='width: 50.55pt; border-top: none; border-left: none; border-bottom: solid windowtext 1.0pt; border-right: solid windowtext 1.0pt; padding: 0cm 5.4pt 0cm 5.4pt; height: 34.0pt'>
					<p class=MsoNormal align=center style='text-align: center'>
						<span lang=EN-US style='font-size: 16.0pt; font-family: 仿宋'>
							<a class="btn btn-small btn-info" href="javascript:void(0)" onClick="uploadFilePDF(4)">
								<i class="icon-upload"></i>管理
							</a>
						</span>
					</p>
			...
			<tr>
				...
				<td width=383 style='width: 287.45pt; border-top: none; border-left: none; border-bottom: solid windowtext 1.0pt; border-right: solid windowtext 1.0pt; padding: 0cm 5.4pt 0cm 5.4pt'>
					<p class=MsoNormal>
						<span style='font-size: 16.0pt; font-family: 仿宋'></span>
					</p>
				</td>
				<td width=67 style='width: 50.5pt; border-top: none; border-left: none; border-bottom: solid windowtext 1.0pt; border-right: solid windowtext 1.0pt; padding: 0cm 5.4pt 0cm 5.4pt'>
					<p class=MsoNormal align=center style='text-align: center; line-height: 150%'>
