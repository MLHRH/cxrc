...
public class ZhichengApply {
	...
	public void setFinial_approve_date(String temp) {
		this.finial_approve_date = temp;
	}
	...
	public Integer getExpert1_date() {
		return expert1_date;
	}
	public void setExpert1_date(Integer expert1_date) {
