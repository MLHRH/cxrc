...
public class UserZhuanliController {
	...
	public String userZhuanliList(HttpServletRequest request, Model model) {
		...
		List<JcqnDocPatent> list = service.getAllByUserId(user.getId().toString());
	...
	public String userZhuanliEdit(HttpServletRequest request, Model model) {
		...
		if ((id != null) && (id.length() >= 1)) {
			JcqnDocPatent user_zhuanli = service.getById(id);
	...
	@ResponseBody
	public String userZhuanliUpdate(HttpServletRequest request, @ModelAttribute JcqnDocPatent entity) {
