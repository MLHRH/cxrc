...
public class JcqnDoc01Dao {
	...
	private final String SQL_INSERT = "insert into jcqn_doc01(user_id,name,sex,minzu,birthday,title,document_type,document_number,direction,declaration_area,telephone,fax,mobile_phone,email,zip_code,addresses,study_country,study_colleges,"
	...
	private final String SQL_SET_UPDATE = "update jcqn_doc01 set name=?,sex=?,minzu=?,birthday=?"
			+ ",title=?,document_type=?"
	...
	public boolean insert(JcqnDoc01 jcqndoc01) {
		...
		return jdbcTemplate.update(SQL_INSERT,
				new Object[] { jcqndoc01.getName(), jcqndoc01.getSex(), jcqndoc01.getMinzu(), jcqndoc01.getBirthday(),
						jcqndoc01.getTitle(), jcqndoc01.getDocument_type(), jcqndoc01.getDocument_number(),
						jcqndoc01.getDeclaration_area(), jcqndoc01.getTelephone(), jcqndoc01.getFax(),
						jcqndoc01.getMobile_phone(), jcqndoc01.getEmail(), jcqndoc01.getZip_code(),
						jcqndoc01.getAddresses(), jcqndoc01.getStudy_country(), jcqndoc01.getStudy_colleges(),
						jcqndoc01.getStudy_major(), jcqndoc01.getStudy_education(), jcqndoc01.getStudy_start_time(),
	...
	public boolean update(JcqnDoc01 jcqndoc01) {
		Object[] params = new Object[] { jcqndoc01.getName(), jcqndoc01.getSex(), jcqndoc01.getMinzu(),
				...
				jcqndoc01.getZip_code(), jcqndoc01.getAddresses(), jcqndoc01.getStudy_country(),
				...
				jcqndoc01.getWork_fax(), jcqndoc01.getUser_id()
