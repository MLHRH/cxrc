...
//					user_award.setDate(temp);
	...
	public boolean Update(JcqnDocPrize user_award) {
		Object[] params = new Object[] { user_award.getXuhao_id(),user_award.getUserId(), user_award.getAwardItemName(), user_award.getPrizeName(), user_award.getGrade(), user_award.getSort(), user_award.getRewardTime(),user_award.getGrantInstitution() };
