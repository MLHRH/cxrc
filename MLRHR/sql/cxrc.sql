...
CREATE DATABASE /*!32312 IF NOT EXISTS*/`cxrc` /*!40100 DEFAULT CHARACTER SET utf8 */;
...
insert  into `apply_group`(`id`,`name`,`pId`,`type`) values (1,'1','1','1');
...
insert  into `calendar`(`id`,`start_date`,`end_date`,`jieshao`) values (1,'2010-01-01','2016-12-31','根据打分表，独立打出分数，并提出合理意见。打分过程一定要按照公平公正的原则，合理打分。严禁一切形式的徇私舞弊，违者直接取消申报资格。<div><br></div><div>&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; 谢谢</div>');
...
insert  into `jcqn_doc04`(`id`,`user_id`,`futurePlans`) values (4,31,'未来是美好的，是光明的，是值得期待的，是需要我们共同创建的');
...
insert  into `jcqn_doc05`(`id`,`user_id`,`needsRelevanceSupport`) values (4,31,'积极思考，加强自身技术，好好工作，努力学习');
