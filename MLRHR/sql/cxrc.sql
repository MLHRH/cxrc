...
) ENGINE=InnoDB AUTO_INCREMENT=66 DEFAULT CHARSET=utf8 COMMENT='申请记录表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `apply` VALUES (65,32,1,'2016-12-16 15:05:56','创新团队','已提交',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL);
...
--
-- Dumping data for table `cxtd_doc03`
--

LOCK TABLES `cxtd_doc03` WRITE;
/*!40000 ALTER TABLE `cxtd_doc03` DISABLE KEYS */;
/*!40000 ALTER TABLE `cxtd_doc03` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `cxtd_doc04`
--

DROP TABLE IF EXISTS `cxtd_doc04`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `cxtd_doc04` (
  `id` bigint(20) NOT NULL AUTO_INCREMENT,
  `user_id` bigint(20) NOT NULL,
...
--
-- Dumping data for table `cxtd_doc04`
--

LOCK TABLES `cxtd_doc04` WRITE;
/*!40000 ALTER TABLE `cxtd_doc04` DISABLE KEYS */;
INSERT INTO `cxtd_doc04` VALUES (1,32,'创新团队aa未来研究计划及当前研究基础');
/*!40000 ALTER TABLE `cxtd_doc04` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `cxtd_doc05`
--

DROP TABLE IF EXISTS `cxtd_doc05`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `cxtd_doc05` (
  `id` bigint(20) NOT NULL AUTO_INCREMENT,
  `user_id` bigint(20) NOT NULL,
...
--
-- Dumping data for table `cxtd_doc05`
--

LOCK TABLES `cxtd_doc05` WRITE;
/*!40000 ALTER TABLE `cxtd_doc05` DISABLE KEYS */;
INSERT INTO `cxtd_doc05` VALUES (1,32,'创新团队工作单位发展需求与推荐人选的相关性及工作单位提供的支持保障措施');
/*!40000 ALTER TABLE `cxtd_doc05` ENABLE KEYS */;
UNLOCK TABLES;
...
INSERT INTO `expert_score` VALUES (3,34,31,'100','很好，很不错',1),(4,34,33,'100','很好',46);
...
INSERT INTO `expert_user` VALUES (10,37,2,NULL,'男','汉','1967','北京','工程师','开发','是','专家'),(11,34,2,3,'男','汉','1987','北京市朝阳区北苑路','java工程师','工程师','是','专家1'),(12,35,1,NULL,'女','汉','196','北京','工程师','工程','是','专家'),(14,38,1,NULL,'男','汉','1966','北京','','','','');
...
-- Dump completed on 2016-12-16 17:06:53